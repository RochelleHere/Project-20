...
//create the canvas and adjust the window sizes to suit th
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(10, 50),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(10, 500),40, 10, 10));
